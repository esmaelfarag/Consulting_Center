    ...
    <div class="navbar-wrapper">
            ...
            <ul class="nav navbar-nav flex-row">
                ...
                <li class="nav-item">
                    <a class="navbar-brand" href="{{route('admin.dashboard')}}">
                        ...
                        <h3 class="brand-text"><span style="color: red">{{__('admin_Translate.consulting')}}</span><span style="color: blue">{{__('admin_Translate.center')}}</span></h3>
                    </a>
                </li>
        ...
        <div class="navbar-container content">
            <div class="collapse navbar-collapse" id="navbar-mobile">
                ...
                <span class="mr-1" style="color:#0b3a29">{{__('admin_Translate.hello')}}
                  <span
                      class="user-name text-bold-700" style="color: white"> {{$LoggedAdminInfo->name}}</span>
                </span>
                            <span class="avatar avatar-online">
                  <img  style="height: 35px;" src="{{asset('assets/images/profile/Admin.png')}}" alt="avatar"><i></i></span>
                        </a>
                        <div class="dropdown-menu dropdown-menu-right"><a class="dropdown-item" href=""><i
                                    class="ft-user"></i> {{__('admin_Translate.edit_profile')}} </a>
                            <div class="dropdown-divider"></div>
                            <a class="dropdown-item" href="{{route('admin.logout')}}" ><i class="ft-power"></i>
                                {{__('admin_Translate.logout')}} </a>
                        </div>
                    </li>
                        ...
                        <ul class="dropdown-menu dropdown-menu-media dropdown-menu-right">
                            <li class="dropdown-menu-header">
                                <h6 class="dropdown-header m-0">
                                    <span class="grey darken-2">{{__('admin_Translate.Notifications')}}</span>
                                </h6>
                                <span
                    ...
                    <li class="dropdown dropdown-notification nav-item">
                        ...
                        <ul class="dropdown-menu dropdown-menu-media dropdown-menu-right">
                            <li class="dropdown-menu-header">
                                <h6 class="dropdown-header m-0">
                                    <span class="grey darken-2">{{__('admin_Translate.Messages')}}</span>
                                </h6>
                                <span
