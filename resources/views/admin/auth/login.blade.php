                ...
                <div class="card border-grey border-lighten-3 m-0">
                    <div class="card-header border-0">
                        <div class="card-title text-center">
                            <div class="p-1">
                                <img src="{{asset('assets/images/profile/Admin.png')}}" alt="LOGO" style="width: 100px;height: 100px;"/>
                    ...
                    <div class="card-content">
                        <div class="card-body">
                            <form class="form-horizontal form-simple" action="{{route('auth.admin.check')}}" method="post"
                                  novalidate>
                                @csrf
                                ...
                                <fieldset class="form-group position-relative has-icon-left mb-0" >
                                    <input type="text" name="email" style="margin-bottom: 10px;" class="form-control form-control-lg input-lg"
